<template>
  <div class="va-tabs" :class="computedTabsClass">
    <div ref="wrapper" class="va-tabs__wrapper" role="tablist" :aria-disabled="$props.disabled">
      <va-button
      ...
      />
      <div ref="container" class="va-tabs__container" :class="computedClass">
        <div ref="tabs" class="va-tabs__tabs" :style="paginationControlledStyles">
          <div class="va-tabs__slider-wrapper" aria-hidden="true" :style="sliderStyles">
...
const getClientWidth = (element: HTMLElement | null | undefined): number =>
...
const { valueComputed: tabSelected }: { valueComputed: WritableComputedRef<TabSelected> } =
...
const movePaginationLeft = () => {
  ...
  for (let i = 0; i < tabsList.value.length - 1; i++) {
    ...
    if (
      (currentTabLeftSidePosition > offsetToSet &&
        currentTabLeftSidePosition < tabsContentOffset.value) ||
